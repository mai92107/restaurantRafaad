...
const menuItemReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case actionType.CREATE_MENU_ITEM_SUCCESS:
            return {
                ...state, loading: false, menuItem: [...state.menuItem, action.payload], message: "Food Created Successfully"
            };
        
        case actionType.GET_MENU_ITEMS_BY_RESTAURANT_ID_SUCCESS:
            return {
                ...state, loading: false, menuItem: action.payload
            };
        
        case actionType.DELETE_MENU_ITEM_SUCCESS:
            return {
                ...state, loading: false, menuItem: state.menuItem.filter(
        ...
        case actionType.UPDATE_MENU_ITEMS_AVAILABILITY_SUCCESS:
            ...
            return {
                ...state, loading: false, menuItem: state.menuItem.map(
